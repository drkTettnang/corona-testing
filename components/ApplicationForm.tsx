          ...
          <form onSubmit={submitForm}>
            ...
            {Array.from({ length: numberOfChildren }, (_, i) => <Box key={i} mt={9} mb={3}>
              ...
              <KeyboardDatePicker
                ...
                maxDateMessage="Geburtstag sollte in der Vergangenheit liegen"
                fullWidth
                required
                disabled={processing}
              />
              <Box mt={2}>
                <Button color="secondary" onClick={() => copyAddress(0, i, children)} disabled={processing}>Kopiere Adresse</Button>
